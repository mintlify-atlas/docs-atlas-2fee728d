...
<Accordion title="Mod Metadata">
  ...
  <AccordionItem title="Gameplay Impact">
...
<Accordion title="Hard Mods">
  <AccordionItem title="Hard Rock (HR)">
  ...
  <AccordionItem title="Flashlight (FL)">
...
<Accordion title="Mods with Settings">
  <AccordionItem title="Difficulty Adjust">
  ...
  <AccordionItem title="Adaptive Speed">
  ...
  <AccordionItem title="Flashlight">
...
<Accordion title="Application Interfaces">
  <AccordionItem title="IApplicableToDifficulty">
  ...
  <AccordionItem title="IApplicableToRate">
  ...
  <AccordionItem title="IApplicableToDrawableHitObject">
  ...
  <AccordionItem title="IApplicableToScoreProcessor">
  ...
  <AccordionItem title="IApplicableToHealthProcessor">
