...
<Accordion title="Core Room Properties">
  ...
  <AccordionItem title="Participants">
...
<Accordion title="Multiplayer Room Settings">
  <AccordionItem title="Queue Mode">
  ...
  <AccordionItem title="Auto-Start">
...
<Accordion title="Score Query Methods">
  <AccordionItem title="Show Playlist Score">
  ...
  <AccordionItem title="Show User Score">
  ...
  <AccordionItem title="Scores Around User">
