...
<Accordion title="Difficulty Parameters">
  ...
  <Accordion title="Circle Size (CS)">
  ...
  <Accordion title="Overall Difficulty (OD)">
  ...
  <Accordion title="Approach Rate (AR)">
  ...
  <Accordion title="Slider Settings">
...
<Accordion title="Difficulty Creation Methods">
  <Accordion title="CreateNewDifficulty">
  ...
  <Accordion title="CopyExistingDifficulty">
