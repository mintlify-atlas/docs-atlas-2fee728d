...
<Accordion title="What Skins Can Provide">
  <AccordionItem title="Visual Components">
  ...
  <AccordionItem title="Audio Samples">
    Sound effects:
  ...
  <AccordionItem title="Configuration Values">
...
<Accordion title="Skin Navigation">
  <AccordionItem title="Next Skin">
    ```csharp
    skinManager.SelectNextSkin();
    ```
  </AccordionItem>
  
  <AccordionItem title="Previous Skin">
    ```csharp
    skinManager.SelectPreviousSkin();
    ```
  </AccordionItem>
  
  <AccordionItem title="Random Skin">
    ```csharp
...
<Accordion title="Skinnable Components">
  <AccordionItem title="Text Elements">
    ```csharp
  ...
  <AccordionItem title="Beatmap Attributes">
    ```csharp
  ...
  <AccordionItem title="Judgement Counter">
    ```csharp
