...
<Card title="Available Match Types" icon="users">
  <Accordion>
    <AccordionItem title="Head-to-Head">
    ...
    <AccordionItem title="Team Versus">
    ...
    <AccordionItem title="Matchmaking (Quick Play)">
    ...
    <AccordionItem title="Ranked Play">
...
<Accordion title="Playlist Operations">
  <AccordionItem title="Add Playlist Item">
  ...
  <AccordionItem title="Edit Playlist Item">
  ...
  <AccordionItem title="Remove Playlist Item">
