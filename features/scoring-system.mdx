...
<Accordion title="Score Components">
  <AccordionItem title="Score Values">
  ...
  <AccordionItem title="Accuracy & Combo">
...
<Accordion title="Mod Storage">
  <AccordionItem title="Internal Format">
  ...
  <AccordionItem title="Accessing Mods">
...
<Accordion title="Score Management Operations">
  <AccordionItem title="Importing Scores">
  ...
  <AccordionItem title="Exporting Scores">
    Export scores to replay files for sharing.
  </AccordionItem>
  
  <AccordionItem title="Downloading Scores">
